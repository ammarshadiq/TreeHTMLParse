...
public class HTMLParsingError extends HTMLTreeNode{
    private String text;
    private javax.swing.Icon icon;
    private int indentStart;
    private String contents;

    public HTMLParsingError(String text){
        this(
                text,
                org.jdesktop.application.Application.
                    ...
                    getIcon("HTMLComponentItems.HTMLParsingError"));
    }

    public HTMLParsingError(String text, javax.swing.Icon icon){
        this.text = text;
        this.icon = icon;
    }
